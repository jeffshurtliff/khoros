...
* Added the :py:mod:`khoros.utils.tests.test_archives` module with the following functions:
    * :py:func:`khoros.utils.tests.test_archives.set_package_path`
    * :py:func:`khoros.utils.tests.test_archives.test_archive_content`
    * :py:func:`khoros.utils.tests.test_archives.test_unarchive_content`
* Added the :py:mod:`khoros.utils.tests.test_users` module with the following functions:
    ...
    * :py:func:`khoros.utils.tests.test_users.test_unsupported_update_sso_id`
    * :py:func:`khoros.utils.tests.test_users.test_get_user_identifiers`
    * :py:func:`khoros.utils.tests.test_users.test_users_table_query`
    * :py:func:`khoros.utils.tests.test_users.test_get_counts`
...
* Added the :py:mod:`khoros.utils.tests.test_error_handling` module with the following functions:
    * :py:func:`khoros.utils.tests.test_error_handling.test_eprint`
    * :py:func:`khoros.utils.tests.test_error_handling.test_get_html_error`
    * :py:func:`khoros.utils.tests.test_error_handling.test_verify_core_object_present`
